...
function Body() {
  return (
    <div className="container" id="body-container">
      <h1 className="titulo">EJEMPLO PARA HOY</h1>
      <p className="parrafo">
        ...
        texto de Lorem Ipsum no es simplemente texto aleatorio. Tiene sus raices
        en una pieza cl´sica de la literatura del Latin, que data del año 45
        ...
        de Hampden-Sydney en Virginia, encontró una de las palabras más oscuras
        de la lengua del latín, "consecteur", en un pasaje de Lorem Ipsum, y al
        seguir leyendo distintos textos del latín, descubrió la fuente
